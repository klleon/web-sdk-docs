...
const CustomReactExample = () => {
  ...
  const sdkHandler = {
    ...
    changeAvatar: () => {
      const { KlleonChat } = window;
      const avatarList = [
        "a53e7088-0090-11ef-8ee1-0abbf354c5cc",
        "a56767cb-0090-11ef-8ee1-0abbf354c5cc",
        "a6124155-0090-11ef-8ee1-0abbf354c5cc",
        "a5fe629d-0090-11ef-8ee1-0abbf354c5cc",
      ];
      const filteredAvatarList = avatarList.filter((id) => id !== AVATAR_ID);
