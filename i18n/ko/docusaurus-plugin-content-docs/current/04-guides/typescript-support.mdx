...
:::info React 버전별 JSX namespace

- **React 19+** (`>=19.0.0`): `React.JSX` namespace 사용
- **React 18-** (`~18.0.0`): `JSX` namespace 사용

프로젝트의 `package.json`에서 React 버전을 확인하여 적절한 namespace를 사용하세요.
:::
