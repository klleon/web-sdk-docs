...
HTML attribute names are the lowercased versions of camelCase property names (`videoStyle` → `videostyle`). In JavaScript/React, use camelCase as-is.
:::
