...
- **message** (string, required): The text message to send to the avatar.
...
Requests the avatar to speak the provided `message` string directly via TTS.

- **message** (string, required): The text message for the avatar to speak.
